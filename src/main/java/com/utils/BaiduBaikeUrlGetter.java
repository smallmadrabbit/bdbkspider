 ...
 */
public class BaiduBaikeUrlGetter {
    private static final ApplicationContext applicationContext = new ClassPathXmlApplicationContext("spring/a*.xml");
    ...
    public BaiduBaikeUrlGetter(Integer startNum, Integer endNum, Integer outTimeSleepTime, Integer periodTime, Integer threadNumber) {
    ...
    public void start(){
        ...
        RunnerThread runnerThread = (RunnerThread) applicationContext.getBean("runnerThread");
